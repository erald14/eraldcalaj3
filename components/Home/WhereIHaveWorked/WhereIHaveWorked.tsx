...
import Dierbro from './Descriptions/Dierbro'
import Horizont from './Descriptions/Horizont'
import Quickbird from './Descriptions/Quickbird'
import RevstarConsulting from './Descriptions/RevstarConsulting'
import Wemolo from './Descriptions/Wemolo'
export default function WhereIHaveWorked() {
    ...
    const GetDescription = () => {
        switch (DescriptionJob) {
            ...
            case 'Quickbird':
                return <Quickbird />
            case 'Revstar Consulting':
                return <RevstarConsulting />
            case 'Horizont':
                return <Horizont />
            case 'Dierbro':
                return <Dierbro />
    ...
    const [DescriptionJob, setDescriptionJob] = React.useState('Wemolo')
    return (
      ...
      overflow-auto scrollbar-hide md:overflow-hidden pb-4 md:pb-0 justify-start
       sm:justify-center items-start sm:items-start"
        >
            {/* // ? left bar Holder */}
            <div
                className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[232px] translate-y-1 md:w-0.5  
            ...
            <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
                <div className="flex flex-row md:flex-col">
                    ...
                    <CompanyButton
                        ...
                        CompanyName="Dierbro (IT)"
                        BarPosition={170}
                        BarAvobePosition={513}
                        DescriptionJob="Dierbro"
