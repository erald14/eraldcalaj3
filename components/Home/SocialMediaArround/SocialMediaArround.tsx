            ...
            >
                <div className="flex flex-col space-y-8 justify-center items-center">
                    <div className="flex flex-col justify-center items-center space-y-5">
                        {/* Github Icon */}
                        <IconClickableWithAnimation Icon={GithubIcon} href={'https://github.com/erald14'} />
                        {/* Linkedin icon */}
                        ...
                        {/* Youtube Icon */}
                        <IconClickableWithAnimation Icon={InstagramIcon} href={'https://www.instagram.com/_erald_/'} />
                    </div>
            ...
            >
                <div className="flex flex-col space-y-24 justify-center items-center">
                    ...
                    <motion.div
                        ...
                        className=""
                    >
                        <a href="mailto:eraldcalaj@gmail.com" target={'_blank'} rel="noreferrer">
                            <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                                eraldcalaj3<span className="text-AAsecondary">@</span>gmail
