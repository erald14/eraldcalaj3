    ...
    return (
        <div className={` ${props.className} bg-AAprimary flex flex-col justify-center items-center py-8 space-y-4 `}>
            ...
            <div className="flex flex-row space-x-8">
                <ClickableIcon href={'https://github.com/erald14'} Icon={GithubIcon} />
                <ClickableIcon href={'https://www.linkedin.com/in/erald-calaj-5b642815b/'} Icon={LinkedinIcon} />
                <ClickableIcon href={'https://www.instagram.com/_erald_/'} Icon={InstagramIcon} />
